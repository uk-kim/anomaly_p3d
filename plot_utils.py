...
class Plot_Reproduce_Performance():
    def __init__(self, DIR, n_img_x=8, n_img_y=2, img_w=224, img_h=224, resize_factor=1.0, direction="H"):
        self.DIR = DIR
    ...
    def save_images(self, images, name='result.jpg'):
        ...
        imsave(self.DIR + "/"+name, self._merge(images))

    def get_merge_images(self, images):
        return self._merge(images)
